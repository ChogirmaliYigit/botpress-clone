...
const asUnionOf = (def, refs) => {
    const unionOf = (def.options instanceof Map
        ...
        : def.options)
        .map((x, i) => (0, parseDef_1.parseDef)(x._def, Object.assign(Object.assign({}, refs), { currentPath: [...refs.currentPath, refs.unionStrategy, `${i}`] })))
        .filter((x) => !!x &&
        (!refs.strictUnions ||
    ...
    return refs.unionStrategy === "anyOf"
        ? Object.assign({ anyOf: unionOf }, discriminator) : Object.assign({ oneOf: unionOf }, discriminator);
};
